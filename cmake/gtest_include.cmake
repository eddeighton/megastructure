...
include( ${MS_THIRD_PARTY_DIR}/gtest/install/lib/cmake/GTest/GTestConfig.cmake )

find_path( GTEST_INCLUDE_DIR NAMES gtest PATHS ${MS_THIRD_PARTY_DIR}/gtest/install/include )
find_path( GTEST_LIBRARY_PATH NAMES "gtest.lib" PATHS ${MS_THIRD_PARTY_DIR}/gtest/install/lib )
find_path( GTEST_MAIN_LIBRARY_PATH NAMES "gtest_main.lib" PATHS ${MS_THIRD_PARTY_DIR}/gtest/install/lib )
